...
app.get('/feedback', function(req,res){
  ...
  sendFeedback(msg,req.query["deviceToken"],res);
});
...
function sendFeedback(msg,deviceToken,res){
  ...
  request.post(
    {
      ...
      json:{"where":{"deviceToken":deviceToken} ,"data":{"alert":msg,"sound": "cheering.caf","sendingDate":sendingtime}}
    },
    function(e,r,body){
     ...
     //console.log("now in recursive: "+monitoringStocks);
      ...
      if(body.results.length==1000)
        ...
        monitoringStocks = allstocks;
         console.log( "in recursive: "+monitoringStocks.length+" "+monitoringStocks);
         callback(allstocks);
}
}//if
    });
